...
public class CheckException {
	...
	public void checkCountByUserRangeMin(int changeCount){
		if(changeCount < 1) throw new IllegalArgumentException("장바구니에 담을 수 있는 단일품목의 최소 수량은 1개입니다. 주문을 처음부터 다시 해주시길 바랍니다.");
	}

	public void checkCountByUserRangeMax(int changeCount) {
        if (50 < changeCount) throw new IllegalArgumentException("장바구니에 담을 수 있는 단일품목의 최대 수량은 50개입니다. 주문을 처음부터 다시 해주시길 바랍니다.");
	}
}
